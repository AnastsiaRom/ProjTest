                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-4">
                                ...
                                <form class="form-signup" method="post" action="{{ route('auth.login') }}">
                                    @csrf
                                    ...
                                    <p class="text-center text-muted mt-3 mb-0">Don't have an account? <a href="{{ route('auth.signup') }}" class="fw-bold text-body"><u>Register now</u></a></p>
